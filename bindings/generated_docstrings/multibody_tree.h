...
Raises:
    ...
    that owns this body.)""";
        ...
        // Symbol: drake::multibody::DeformableBody::CalcElasticEnergy
        struct /* CalcElasticEnergy */ {
          // Source: drake/multibody/tree/deformable_body.h
          const char* doc =
R"""(Calculates the body's internal elsatic energy.
...
Returns ``E``:
    the body's internal elsatic energy.
...
Raises:
    ...
    that owns this body.)""";
        ...
        // Symbol: drake::multibody::DeformableBody::ModelType
        struct /* ModelType */ {
          // Source: drake/multibody/tree/deformable_body.h
          const char* doc = R"""()""";
          // Symbol: drake::multibody::DeformableBody::ModelType::kDer
          struct /* kDer */ {
            // Source: drake/multibody/tree/deformable_body.h
            const char* doc = R"""()""";
          } kDer;
          // Symbol: drake::multibody::DeformableBody::ModelType::kFem
          struct /* kFem */ {
            // Source: drake/multibody/tree/deformable_body.h
            const char* doc = R"""()""";
          } kFem;
...
R"""(Returns physical parameters of this deformable body.)""";
        ...
        // Symbol: drake::multibody::DeformableBody::der_model
        struct /* der_model */ {
          // Source: drake/multibody/tree/deformable_body.h
          const char* doc =
R"""(Returns the DerModel for this deformable body.

Precondition:
    ``model_type() == kDer``.)""";
        } der_model;
        // Symbol: drake::multibody::DeformableBody::der_state_cache_index
        struct /* der_state_cache_index */ {
          // Source: drake/multibody/tree/deformable_body.h
          const char* doc =
R"""(Returns the cache index for the DerState of this deformable body.

Precondition:
    ``model_type() == kDer``.)""";
        } der_state_cache_index;
...
Precondition:
    ``model_type() == kFem``.)""";
        ...
        // Symbol: drake::multibody::DeformableBody::fixed_constraint_specs2
        struct /* fixed_constraint_specs2 */ {
          // Source: drake/multibody/tree/deformable_body.h
          const char* doc =
R"""((Internal use only) Returns a reference to the fixed constraints
registered with this deformable body.
...
deformable body is enabled.)""";
        ...
        // Symbol: drake::multibody::DeformableBody::model_type
        struct /* model_type */ {
          // Source: drake/multibody/tree/deformable_body.h
          const char* doc = R"""()""";
        } model_type;
        // Symbol: drake::multibody::DeformableBody::mutable_der_model
        struct /* mutable_der_model */ {
          // Source: drake/multibody/tree/deformable_body.h
          const char* doc =
R"""(Returns the mutable DerModel for this deformable body.
