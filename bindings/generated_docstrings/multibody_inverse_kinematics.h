...
R"""(Sets the default state of the controller.)""";
        ...
        // Symbol: drake::multibody::DifferentialInverseKinematicsController::SetInitialPositions
        struct /* SetInitialPositions */ {
          // Source: drake/multibody/inverse_kinematics/differential_inverse_kinematics_controller.h
          const char* doc =
R"""(Sets the initial value of the DiscreteTimeIntegrator to ``value``.
