...
Raises:
    RuntimeError if no body with the given ``id`` has been registered.)""";
        ...
        // Symbol: drake::multibody::DeformableModel::GetDerModel
        struct /* GetDerModel */ {
          // Source: drake/multibody/plant/deformable_model.h
          const char* doc =
R"""(Returns the DerModel for the body with ``id``.
...
Raises:
    exception if ``get_model_type(id) != ModelType::kDer``.)""";
        } GetDerModel;
...
Raises:
    exception if ``get_model_type(id) != ModelType::kFem``.)""";
        } GetFemModel;
...
Raises:
    ...
    called.)""";
        ...
        // Symbol: drake::multibody::DeformableModel::der_integrator
        struct /* der_integrator */ {
          // Source: drake/multibody/plant/deformable_model.h
          const char* doc =
R"""((Internal use only) Returns the time integrator used to for all
DerModels in this model.

Raises:
    RuntimeError if the integrator hasn't been set.)""";
        } der_integrator;
        // Symbol: drake::multibody::DeformableModel::fem_integrator
        struct /* fem_integrator */ {
          // Source: drake/multibody/plant/deformable_model.h
          const char* doc =
R"""((Internal use only) Returns the time integrator used to for all
...
Raises:
    RuntimeError if the integrator hasn't been set.)""";
        ...
        // Symbol: drake::multibody::DeformableModel::get_model_type
        struct /* get_model_type */ {
          // Source: drake/multibody/plant/deformable_model.h
          const char* doc =
R"""(Returns the model type for the body with ``id``.
